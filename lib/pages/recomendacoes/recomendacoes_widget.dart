                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'o434nw7a' /* 💡 Baseado nos seus dados, tem... */,
                        ),
                        style:
                                    ...
                                    child: Align(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'bw56w1aw' /* Essa é uma porcentagem baixa, ... */,
                                            ),
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'n4ajni6j' /* 🏃‍♂️ Exercise Recomendations */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .titleMedium
                                      .override(
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'rx25nv84' /* Exercícios aeróbicos regulares... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
